...
public static class ThrowsAsyncAssert
{
	...
	public static T ThrowsAsync<T>(Task task, string expectedMessage, ExceptionMessageCompareOptions messageOptions,
		ExceptionInheritanceOptions inheritOptions) where T : Exception
	{
		try
		{
			task.Wait();
	...
	public static T ThrowsAsync<T>(this IAssertion assertion, Task task,
		ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits) where T : Exception
	{
		return ThrowsAsync<T>(task, null, ExceptionMessageCompareOptions.None, inheritOptions);
	}

	public static T ThrowsAsync<T>(Task task, ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits)
		where T : Exception
	{
		return ThrowsAsync<T>(task, null, ExceptionMessageCompareOptions.None, inheritOptions);
	}

	public static T ThrowsAsync<T>(this IAssertion assertion, Task task, string expectedMessage,
		ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits) where T : Exception
	{
		return ThrowsAsync<T>(task, expectedMessage, ExceptionMessageCompareOptions.Exact, inheritOptions);
	}

	public static T ThrowsAsync<T>(Task task, string expectedMessage,
		ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits) where T : Exception
	{
		return ThrowsAsync<T>(task, expectedMessage, ExceptionMessageCompareOptions.Exact, inheritOptions);
	}

	public static T ThrowsAsync<T>(this IAssertion assertion, Task task, string expectedMessage, ExceptionMessageCompareOptions options,
		ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits) where T : Exception
	{
		return ThrowsAsync<T>(task, expectedMessage, options, inheritOptions);
	}

	public static Exception ThrowsAsync(this IAssertion assertion, Task task, string expectedMessage,
		ExceptionMessageCompareOptions options, ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits)
	{
		return ThrowsAsync<Exception>(task, expectedMessage, options, inheritOptions);
	}

	public static Exception ThrowsAsync(Task task, string expectedMessage, ExceptionMessageCompareOptions options,
		ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits)
	{
		return ThrowsAsync<Exception>(task, expectedMessage, options, inheritOptions);
	}
	...
	public static Exception ThrowsAsync(Task task, string expectedMessage,
		ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits)
	{
		return ThrowsAsync<Exception>(task, expectedMessage, ExceptionMessageCompareOptions.Exact, inheritOptions);
	}

	public static Exception ThrowsAsync(this IAssertion assertion, Task task,
		ExceptionInheritanceOptions inheritOptions = ExceptionInheritanceOptions.Inherits)
	{
